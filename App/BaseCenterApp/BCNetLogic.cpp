...
void BCNetLogic::OnMessage(const NetPacket& packet)
{
...
void BCNetLogic::OnRegisterApp(const NetMessage* nmsg, int fd)
{
	MsgRegisterApp msg;
...
void BCNetLogic::OnUnRegisterApp(const NetMessage* nmsg)
{
